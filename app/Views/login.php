            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <h5 class="card-title text-center pb-0 fs-4">Event Putri</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body bg-info">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Masuk Menggunakan Akun</h5>
              ...
              <div class="credits">
                ...
                Copy Right <a href="https://bootstrapmade.com/">Putri Wulandari</a>
              </div>
